...
import { isAllowedExtensionVersion } from "src/backend/pstream/extension/compatibility";
import { ExtensionMakeRequestResponse } from "src/backend/pstream/extension/plasmo";
